...
- Prepared localization-friendly readout follow-up on 2026-06-06:
  ...
  - do not run it before the interrupted `stepcond_attention_readout` and the already prepared `class_attention` candidate are completed or deliberately skipped.
